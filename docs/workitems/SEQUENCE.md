...
**Policy family complete** (C-30 closed superseded 2026-09-15). Open foundation work outside this chain: e.g. [C-39](completed/20260917-policy-archive-workbench/STORY.md) archive viewer (done), [C-20](planned/store-text-search/STORY.md), [C-40](completed/20260924-graph-entity-edge-vocab/STORY.md) entity/edge vocab (done), [C-35](completed/20260923-codegen-schema-evolution/STORY.md) (done), [C-43](completed/20260925-codegen-write-type-catalog/STORY.md) write catalog (done), [C-44](planned/codegen-aggregate-materializer/STORY.md) aggregate materializer (planned).
