...
3. **C-19** [`foundation-after-versions`](planned/foundation-after-versions/STORY.md) — **after versions**: reverse lookup of deep-version pins, remaining matcher ops (FB-3 **except** contains/`q`). Clocks are C-18.
...
C-17 and C-18 are **done**. Do not start C-19 until C-18 deep graph versions exist (they do). Do not start C-20 implementation until C-20 WI-001 closes open GAPS (C-17 paging is shipped).
