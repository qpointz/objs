...
C-17 and C-18 are **done**. Do not start C-19 until C-18 deep graph versions exist (they do). Do not start C-20 implementation until C-20 WI-001 closes open GAPS (C-17 paging is shipped). Do not start C-24 implementation (WI-002+) until C-24 WI-001 closes open GAPS.
