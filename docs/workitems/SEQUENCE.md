...
| 6 | **C-28** | [`policy-seeds-persistence`](in-progress/policy-seeds-persistence/STORY.md) | **in-progress** | **C-27** | **C-29** |
...
**Next to work now:** C-28 [`policy-seeds-persistence`](in-progress/policy-seeds-persistence/STORY.md) (in progress).
