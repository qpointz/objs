...
- [`multi-bom-app-versions`](in-progress/multi-bom-app-versions/STORY.md) — Multi-BOM constituents + Combined SBOM; multi-draft with target version; progressive UI; Applications portal stats (D-8). WI-000 done; WI-001…WI-008 pending.
