...
- README sufficient for another developer to run export without reading story WIs
- Exported copy: `rg 'docs/workitems/' docs/design AGENTS.md` → zero hits
- G-7, G-8 closed or deferred with note in GAPS
