...
**Status:** in-progress  
**Folder:** [`docs/workitems/in-progress/policy-seeds-persistence/`](.)  
**Backlog:** [C-28](../../BACKLOG.md)  
**Sequence:** [policy family](../../SEQUENCE.md#policy-family-c-24c-32--normative-order) step **6 / 8**  
**Before:** [C-27 `policy-suites`](../../completed/20260905-policy-suites/STORY.md) (suite seed kinds; result shape locked, **not** result store); hard require [C-24](../../completed/20260904-policy-evaluate-core/STORY.md) (+ C-32 categories)  
...
**C-27 results sketch (not this story):** [`RESULTS-MODEL.md`](../../completed/20260905-policy-suites/RESULTS-MODEL.md)
...
C-27 locked **result API shape** only. [`RESULTS-MODEL.md`](../../completed/20260905-policy-suites/RESULTS-MODEL.md) does **not** mandate result Flyway in this story.
