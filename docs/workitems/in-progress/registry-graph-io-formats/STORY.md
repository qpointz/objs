...
- [ ] WI-001 — Registry seeds import/export (`WI-001-registry-seeds-io.md`)
- [ ] WI-002 — Graph seeds import/export; remove `/seeds/**` (`WI-002-graph-seeds-io.md`)
- [ ] WI-003 — Full-catalog JSON Schema export (`WI-003-full-catalog-json-schema.md`)
