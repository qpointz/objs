...
| C-29 | Thin policy batch / result pack (no matrix; after results) | feature | done | [`completed/20260912-policy-batch/`](completed/20260912-policy-batch/STORY.md) |
| C-30 | Optional policy REST / example consumer (superseded: C-31 REST + SBOM assessment) | feature | done | [`completed/20260915-policy-consumer/`](completed/20260915-policy-consumer/STORY.md) |
...
| C-35 | Typed multi-version deserialize + hand migrations (latest OM codegen; Lane B snapshots) | feature | done | [`completed/20260923-codegen-schema-evolution/`](completed/20260923-codegen-schema-evolution/STORY.md), [`DESIGN.md`](completed/20260923-codegen-schema-evolution/DESIGN.md) |
...
| P-5 | Export package-sensitive assets (`.drl`) + codegen foundation-dir path guard | fix | done | [`completed/20260912-export-package-sensitive-assets/`](completed/20260912-export-package-sensitive-assets/STORY.md) |
