...
|---|------|------|--------|--------|
| C-1 | Entity graph foundation (domain, subgraph, validation, persistence) | feature | in-progress | [`in-progress/entity-graph-foundation/`](in-progress/entity-graph-foundation/STORY.md) |
