...
| Scenario | Story |
|----------|--------|
| Suite hierarchy + folder roll-up (former E6) | [policy-suites](../../completed/20260905-policy-suites/STORY.md) |
| Seeds / MERGE packs | [policy-seeds-persistence](../../in-progress/policy-seeds-persistence/STORY.md) |
