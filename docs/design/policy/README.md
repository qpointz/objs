...
**Status:** C-24 S1 **shipped**; C-26 Drools adapter **shipped**; C-31 Policy playground **shipped**; C-32 policy metadata **shipped**; C-27 suites **shipped**; C-28 catalog seeds + JPA **shipped**; **C-33** evaluation archives **shipped**
