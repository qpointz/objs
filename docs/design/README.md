...
| Core | [`core/README.md`](core/README.md), [`core/spring-integration.md`](core/spring-integration.md), [`core/transaction-recipes.md`](core/transaction-recipes.md), [`core/spring-split.md`](core/spring-split.md), [`core/persistence-backends.md`](core/persistence-backends.md) | Boot how-to, TX recipes, `objs-api` / Spring-free `objs-persistence` / `objs-autoconfigure` (C-25) |
