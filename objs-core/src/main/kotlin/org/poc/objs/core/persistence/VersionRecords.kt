...
data class EntityVersionId(
    var entityId: UUID = UUID.randomUUID(),
    var version: Long = 0,
) : Serializable

@Entity(name = "BoMEntityVersionRecord")
@Table(name = "objs_entity_version")
...
data class GraphVersionId(
    var graphId: UUID = UUID.randomUUID(),
    var version: Long = 0,
) : Serializable

@Entity(name = "BoMGraphVersionRecord")
@Table(name = "objs_graph_version")
@IdClass(GraphVersionId::class)
...
data class EdgeVersionId(
    var edgeId: UUID = UUID.randomUUID(),
    var version: Long = 0,
) : Serializable

@Entity(name = "BoMEdgeVersionRecord")
@Table(name = "objs_graph_edge_version")
@IdClass(EdgeVersionId::class)
...
data class GraphVersionEdgeId(
    var graphId: UUID = UUID.randomUUID(),
    var graphVersion: Long = 0,
    var edgeId: UUID = UUID.randomUUID(),
) : Serializable

@Entity(name = "BoMGraphVersionEdgeRecord")
@Table(name = "objs_graph_version_edge")
@IdClass(GraphVersionEdgeId::class)
class GraphVersionEdgeRecord(
    @Id
    @Column(name = "graph_id", nullable = false)
    var graphId: UUID = UUID.randomUUID(),
