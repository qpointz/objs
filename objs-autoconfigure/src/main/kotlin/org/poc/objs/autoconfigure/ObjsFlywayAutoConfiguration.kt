...
import org.poc.objs.core.persistence.ObjsFlywayProperties
import org.poc.objs.core.persistence.ObjsFlywayVendor
...
class ObjsFlywayAutoConfiguration {
    ...
    @ConditionalOnMissingBean(ObjsFlywayProperties::class)
    fun objsFlywayProperties(): ObjsFlywayProperties = ObjsFlywayProperties()
