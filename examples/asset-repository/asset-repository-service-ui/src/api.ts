...
export function getAllowedEdges(type: string): Promise<TypeAllowedEdges> {
  return fetch(`${API}/schema-catalog/${encodeURIComponent(type)}/allowed-edges`).then((r) => json(r))
}
