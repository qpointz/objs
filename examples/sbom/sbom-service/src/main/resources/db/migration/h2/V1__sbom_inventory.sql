...
-- H2: VARCHAR ARRAY (not TEXT[]); no fingerprint category CHECK (H2 MODE=PostgreSQL mishandles it).

CREATE TABLE sbom_application (
    id UUID NOT NULL PRIMARY KEY,
    name VARCHAR(255) NOT NULL,
    description VARCHAR(2048),
    tags VARCHAR ARRAY NOT NULL DEFAULT CAST(ARRAY[] AS VARCHAR ARRAY),
