...
object SbomDemoApps {
    val all: List<DemoAppSpec> =
        listOf(
            ...
            app(4, "Card Issuing Platform", "Virtual and physical card issuing, PAN tokenization", SbomDemoIds.CATEGORY_PAYMENTS, DemoStack.JAVA, "3.1.0", 3, attachVuln = true),
            ...
            app(7, "Fraud Detection Engine", "Real-time scoring of card and A2A payments", SbomDemoIds.CATEGORY_PAYMENTS, DemoStack.PYTHON, "0.9.4", 3, includeDataset = true, attachVuln = true),
            ...
            app(10, "Mobile Banking Android BFF", "BFF for Android retail banking clients", SbomDemoIds.CATEGORY_DIGITAL, DemoStack.JAVA, "6.2.0", 3, attachVuln = true),
            app(11, "Online Banking Web", "Responsive online banking SPA and edge BFF", SbomDemoIds.CATEGORY_DIGITAL, DemoStack.WEB, "8.1.3", 5, attachVuln = true),
            ...
            app(14, "Notification Hub", "Email, SMS, and push orchestration", SbomDemoIds.CATEGORY_DIGITAL, DemoStack.PYTHON, "3.3.1", 3, attachVuln = true),
            ...
            app(18, "Trading Desk UI", "Advisor order-entry workstation", SbomDemoIds.CATEGORY_WEALTH, DemoStack.WEB, "2.11.0", 2, attachVuln = true),
            app(19, "Market Data Ingest", "Refinitiv/Bloomberg tick normalization", SbomDemoIds.CATEGORY_WEALTH, DemoStack.PYTHON, "1.2.8", 4, includeDataset = true, attachVuln = true),
            ...
            app(22, "Policy Admin System", "Life and P&C policy lifecycle", SbomDemoIds.CATEGORY_INSURANCE, DemoStack.JAVA, "12.0.0", 5, attachVuln = true),
            app(23, "Claims Processing", "FNOL, adjudication, and payouts", SbomDemoIds.CATEGORY_INSURANCE, DemoStack.JAVA, "5.4.1", 3, includeDataset = true, attachVuln = true),
            app(24, "Underwriting Workbench", "Risk rules and referral queues", SbomDemoIds.CATEGORY_INSURANCE, DemoStack.WEB, "2.0.3", 2),
            app(25, "Quote Engine", "Rating and bind APIs for brokers", SbomDemoIds.CATEGORY_INSURANCE, DemoStack.PYTHON, "1.9.0", 3, attachVuln = true),
            app(26, "Broker Portal", "External broker self-service", SbomDemoIds.CATEGORY_INSURANCE, DemoStack.WEB, "4.3.0", 2),
            app(27, "Cash Management", "Corporate liquidity and sweeps", SbomDemoIds.CATEGORY_CORPORATE_BANKING, DemoStack.JAVA, "3.8.0", 3, attachVuln = true),
            app(28, "Trade Finance", "Letters of credit and guarantees", SbomDemoIds.CATEGORY_CORPORATE_BANKING, DemoStack.JAVA, "2.2.1", 2),
            app(29, "FX Pricing Engine", "Spot/forward pricing and spreads", SbomDemoIds.CATEGORY_CORPORATE_BANKING, DemoStack.PYTHON, "0.7.5", 2, includeDataset = true, attachVuln = true),
            ...
            app(32, "Customer 360 Lakehouse", "Conformed customer entities on Iceberg", SbomDemoIds.CATEGORY_DATA, DemoStack.PYTHON, "0.18.0", 4, includeDataset = true, attachVuln = true),
            ...
            app(34, "AML Transaction Monitor", "Scenario detection and SAR caseing", SbomDemoIds.CATEGORY_DATA, DemoStack.PYTHON, "4.1.0", 3, includeDataset = true, attachVuln = true),
            ...
            app(37, "Recommendation Engine", "Next-best-product ranking", SbomDemoIds.CATEGORY_DATA, DemoStack.PYTHON, "1.3.0", 3, includeDataset = true, attachVuln = true),
            ...
            app(39, "API Gateway", "Edge routing, rate limits, and WAF integration", SbomDemoIds.CATEGORY_PLATFORM, DemoStack.JAVA, "8.4.0", 4, attachVuln = true),
            ...
            app(42, "Observability Stack", "Metrics, traces, and log routing", SbomDemoIds.CATEGORY_PLATFORM, DemoStack.MIXED, "2.9.1", 3, attachVuln = true),
            ...
            app(44, "Secrets Manager", "App-role secrets and rotation", SbomDemoIds.CATEGORY_PLATFORM, DemoStack.JAVA, "3.2.0", 2, attachVuln = true),
            ...
            app(47, "Procurement Catalog", "Vendor items and purchase orders", SbomDemoIds.CATEGORY_CORP_FUNCTIONS, DemoStack.JAVA, "2.3.0", 2, attachVuln = true),
            ...
            app(50, "Facilities IoT Hub", "Badge, HVAC, and occupancy telemetry", SbomDemoIds.CATEGORY_CORP_FUNCTIONS, DemoStack.PYTHON, "1.4.0", 2, includeDataset = true, attachVuln = true),
            app(51, "Branch Platform", "Teller and branch appointment orchestration", SbomDemoIds.CATEGORY_RETAIL, DemoStack.JAVA, "3.0.1", 3, attachVuln = true),
            ...
            app(54, "ESG Reporting", "Financed-emissions and sustainability disclosures", SbomDemoIds.CATEGORY_CORP_FUNCTIONS, DemoStack.PYTHON, "0.6.2", 2, includeDataset = true, attachVuln = true),
            app(55, "Loan Origination", "Retail unsecured and mortgage origination", SbomDemoIds.CATEGORY_RETAIL, DemoStack.JAVA, "8.3.0", 5, attachVuln = true),
            app(56, "Collections Workspace", "Delinquency strategies and agent desktop", SbomDemoIds.CATEGORY_RETAIL, DemoStack.WEB, "2.1.4", 2),
            app(57, "ATM Switch", "ISO 8583 routing for ATM and POS", SbomDemoIds.CATEGORY_PAYMENTS, DemoStack.JAVA, "4.4.0", 3, attachVuln = true),
            ...
            app(65, "Chaos Console", "Game-day experiments against platform SLOs", SbomDemoIds.CATEGORY_PLATFORM, DemoStack.WEB, "0.5.1", 1, attachVuln = true),
            app(66, "Payroll Engine", "Gross-to-net and statutory filings", SbomDemoIds.CATEGORY_CORP_FUNCTIONS, DemoStack.JAVA, "9.2.0", 4, attachVuln = true),
